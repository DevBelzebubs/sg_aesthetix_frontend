...
import { ArrowLeft, Folder, Loader2, Plus, Search, Trash2, X } from "lucide-react";
          ...
          {paginatedItems.length === 0 ? (
            <div className="col-span-full flex flex-col items-center gap-3 py-16">
              ...
              <p className="text-sm text-[var(--text-muted)]">
                {query ? "No se encontraron categorías con ese filtro." : "No hay categorías de servicios registradas."}
              </p>
            </div>
          ) : (
        ...
        <div className="rounded-3xl border border-[var(--border)] bg-[var(--background-secondary)] p-6 shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[var(--text-muted)]">
                {mode === "create"
                  ? "Agrega una categoría para servicios."
